...
--  包含: 管理员账号、6台设备、6名维修人员、4条SOP、6个案例、12个备件
-- ============================================================
...
-- ===== 6名维修人员 =====
INSERT INTO workorder_maintenance_personnel (employee_no, name, phone, specializations, skill_level, certification, max_workload) VALUES
...
('E001', '$2a$10$QiUD0hIi91K2NzBx8YN/R.4KXD3.0H8A3s1mg2x9Ew.atUPOE6S7q', 'MAINTENANCE_ENGINEER')
ON CONFLICT (username) DO NOTHING;
...
('SOP-ARC-001', 'ARC_FURNACE', 'MECHANICAL_JAM', '电弧炉机械卡涩标准处理流程',
 ...
 '["机械","电气"]', '["红外测温枪","万用表","百分表","拉马","扭矩扳手","高温润滑脂"]', '["BRG-EAF-001","CPL-EAF-003","LUB-HT-001"]', 120, 'admin'),
...
('SOP-ARC-002', 'ARC_FURNACE', 'COOLING_INTERRUPT', '电弧炉冷却中断应急处理流程',
 ...
 '["液压","机械"]', '["红外测温枪","压力表","管路压力测试仪","备用泵组启动钥匙"]', '["PUMP-EAF-CL01","PIPE-HP-002","VLV-BP-001"]', 45, 'admin'),
...
('SOP-PUMP-001', 'PUMP', 'MECHANICAL_JAM', '循环水泵卡涩排查与维修流程',
 ...
 '["机械","液压"]', '["百分表","扭矩扳手","轴承拉马","动平衡机","机械密封安装工具"]', '["BRG-PMP-001","SEAL-MECH-12","GASKET-EPDM-6"]', 90, 'admin'),
...
('SOP-COMP-001', 'COMPRESSOR', 'MECHANICAL_JAM', '空压机卡涩处理流程',
 ...
 '["机械","电气"]', '["万用表","油品检测仪","滤芯扳手","皮带张紧计"]', '["OIL-COMP-SYN46","FILT-COMP-AIR01","BELT-V-1200"]', 60, 'admin')
...
('CASE-001', '电弧炉轴承卡涩导致振动超标', 'ARC_FURNACE', 'MECHANICAL_JAM',
 ...
 180, '张工', '电弧炉,轴承卡涩,振动超标,润滑失效,联轴器', '2026-03-15 14:30:00'),
...
('CASE-002', '电弧炉冷却水压力骤降应急处置', 'ARC_FURNACE', 'COOLING_INTERRUPT',
 ...
 120, '李工', '电弧炉,冷却中断,压力骤降,机械密封损坏,过滤器堵塞', '2026-04-02 09:15:00'),
...
('CASE-003', '循环水泵异常振动导致冷却水波动', 'PUMP', 'MECHANICAL_JAM',
 ...
 150, '王工', '水泵,振动异常,叶轮异物,动平衡破坏,轴承疲劳', '2026-04-18 11:00:00'),
...
('CASE-004', '空压机高温停机故障', 'COMPRESSOR', 'MECHANICAL_JAM',
 ...
 120, '赵工', '空压机,高温停机,润滑油变质,滤芯堵塞', '2026-05-05 16:45:00'),
...
('CASE-005', '电弧炉联轴器弹性体老化导致频繁卡涩', 'ARC_FURNACE', 'MECHANICAL_JAM',
 ...
 60, '孙工', '电弧炉,联轴器,弹性体老化,间歇振动,扭矩波动', '2026-05-22 08:00:00'),
...
('CASE-006', '水泵机械密封泄漏处理', 'PUMP', 'COOLING_INTERRUPT',
 ...
 90, '李工', '水泵,机械密封泄漏,水垢,冷却水硬度,O型圈老化', '2026-06-01 13:30:00')
