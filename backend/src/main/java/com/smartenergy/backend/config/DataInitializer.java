...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedDefaultDevices() {
        List<Device> defaults = List.of(
                buildDevice("EAF-01", "1号电弧炉", "ARC_FURNACE", "RUNNING", "炼钢一车间", "核心高耗能设备—废钢熔化与初步合金化"),
                buildDevice("PUMP-01", "循环水泵", "PUMP", "STOPPED", "公辅站", "冷却系统关键泵组—向电弧炉/连铸提供冷却水"),
                buildDevice("COMP-01", "空压机A", "COMPRESSOR", "STOPPED", "动力站", "压缩空气主设备—气动阀门与仪表气源"),
                buildDevice("LF-01", "钢包精炼炉", "LADLE_FURNACE", "STOPPED", "炼钢一车间", "钢水二次精炼—合金化/脱硫/调温"),
                buildDevice("CC-01", "1号连铸机", "CONTINUOUS_CASTER", "STOPPED", "连铸跨", "钢水连续浇铸成坯—弧形连铸机"),
                buildDevice("DC-01", "主除尘系统", "DUST_COLLECTOR", "STOPPED", "环保站", "电弧炉烟气捕集与布袋除尘—环保合规")
        );
    ...
    private Device buildDevice(String code, String name, String type, String status, String location, String description) {
